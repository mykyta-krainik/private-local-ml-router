...
/**
 * Path C — cloud API client. Minimal OkHttp wrapper; the concrete endpoint/headers
 * depend on the chosen provider (Gemini, OpenAI, etc.). Expected to receive a query
 * that is either safe or already redacted via [com.example.privacyrouter.redaction.PiiRedactor].
 */
